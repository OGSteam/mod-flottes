...
if (sizeof($dates) > 0) {
    ...
    if (
        isset($pub_start_date) && isset($pub_end_date) &&
...
<center>
    <form method="get" action="index.php">
        ...
        <table>
            ...
            <tr>
                <th><U>intervalle d'étude</U>: du <input type="text" size="10" maxlength="10" name="start_date" value="<?php echo date("d M Y", $min_date + 60 * 60 * 2); ?>" /> au <input type="text" size="10" maxlength="10" name="end_date" value="<?php echo date("d M Y", $max_date); ?>" /> <input type="submit" value="envoyer" /></th>
    ...
    while ($ranking = current($individual_ranking)) {
        ...
        $tab_rank = "\t\t\t" . "<th width='180'>" . date("d M Y H:i", $v) . "</th>" . "\n" . $tab_rank;
        $tab_rank = "\t\t" . "<tr>" . "\n" . $tab_rank;
    ...
    $title = "Basé sur vos données dans \"Empire\" et les stats de " . $nom_player . " du " . date("d M Y H:i", $last_date["general"]);
